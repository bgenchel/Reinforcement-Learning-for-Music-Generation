...
class GANLoss(nn.Module):
    ...
    def forward(self, probs, targets, rewards):
        ...
        # import pdb
        # pdb.set_trace()
        # the `loss` term is the log softmax of the probability, meaning that
        # a high negative number means very unlikely, and a number near 0 means likely.
        # rewards are actually given as a probability, so it should be between 0 and 1 
